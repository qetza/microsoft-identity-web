...
namespace Microsoft.Identity.Web
{
    ...
    internal interface ITokenAcquisitionInternal : ITokenAcquisition
    {
        ...
        /// </code>
        /// </example>
        Task AddAccountToCacheFromAuthorizationCodeAsync(AuthorizationCodeReceivedContext context, IEnumerable<string> scopes, string authenticationScheme = OpenIdConnectDefaults.AuthenticationScheme);
