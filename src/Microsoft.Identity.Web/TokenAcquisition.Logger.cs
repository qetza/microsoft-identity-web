    ...
    internal partial class TokenAcquisition
    {
        private static class Logger
        {
          ...
          LoggerMessage.Define<long, long, long>(
              ...
              "[MsIdWeb] Time in to get token by MSAL: DurationTotalInMs: {DurationTotalInMs} DurationInHttpInMs: {DurationInHttpInMs} DurationInCacheInMs: {DurationInCacheInMs} ");
